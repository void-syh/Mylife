...
.theme-one .calc-display {
  border-bottom: 1px solid #eee;
  height: 40%;
  display: flex;
  flex-direction: column;
}
.theme-one .calc-display .content {
  position: relative;
  flex-grow: 1;
  text-align: right;
...
.theme-one .calc-display .content div {
  position: absolute;
  right: 0;
  bottom: 0;
}
.theme-one .calc-display .result {
...
.theme-one .calc-input {
  height: 60%;
}
.theme-one .calc-input ul {
  height: 100%;
  display: flex;
  flex-direction: column;
...
.theme-one .calc-input ul li ul {
  display: flex;
  flex-direction: row;
  justify-content: space-between;
}
.theme-one .calc-input ul li ul li {
  flex-flow: 1;
  width: 40px;
  height: 40px;
  text-align: center;
...
.theme-two .calc-display {
  border-bottom: 1px solid #eee;
  height: 40%;
  display: flex;
  flex-direction: column;
}
.theme-two .calc-display .content {
  position: relative;
  flex-grow: 1;
  text-align: right;
  word-break: break-all;
...
.theme-two .calc-display .content div {
  position: absolute;
  right: 0;
  bottom: 0;
}
.theme-two .calc-display .result {
  display: inline-block;
  padding: 8px 0;
  height: 36%;
  text-align: right;
...
.theme-two .calc-input {
  height: 60%;
}
.theme-two .calc-input ul {
  height: 100%;
  display: flex;
  flex-direction: column;
  align-items: space-around;
...
.theme-two .calc-input ul li ul {
  display: flex;
  flex-direction: row;
  justify-content: space-between;
}
.theme-two .calc-input ul li ul li {
  flex-flow: 1;
  width: 40px;
  height: 40px;
  text-align: center;
...
.theme-three .calc-display {
  border-bottom: 1px solid #eee;
  height: 40%;
  display: flex;
  flex-direction: column;
}
.theme-three .calc-display .content {
  position: relative;
  flex-grow: 1;
  text-align: right;
  word-break: break-all;
...
.theme-three .calc-display .content div {
  position: absolute;
  right: 0;
  bottom: 0;
}
.theme-three .calc-display .result {
  display: inline-block;
  padding: 8px 0;
  height: 36%;
  text-align: right;
...
.theme-three .calc-input {
  height: 60%;
}
.theme-three .calc-input ul {
  height: 100%;
  display: flex;
  flex-direction: column;
  align-items: space-around;
...
.theme-three .calc-input ul li ul {
  display: flex;
  flex-direction: row;
  justify-content: space-between;
}
.theme-three .calc-input ul li ul li {
  flex-flow: 1;
  width: 40px;
  height: 40px;
  text-align: center;
...
.theme-four .calc-display {
  border-bottom: 1px solid #eee;
  height: 40%;
  display: flex;
  flex-direction: column;
}
.theme-four .calc-display .content {
  position: relative;
  flex-grow: 1;
  text-align: right;
  word-break: break-all;
...
.theme-four .calc-display .content div {
  position: absolute;
  right: 0;
  bottom: 0;
}
.theme-four .calc-display .result {
  display: inline-block;
  padding: 8px 0;
  height: 36%;
  text-align: right;
...
.theme-four .calc-input {
  height: 60%;
}
.theme-four .calc-input ul {
  height: 100%;
  display: flex;
  flex-direction: column;
  align-items: space-around;
...
.theme-four .calc-input ul li ul {
  display: flex;
  flex-direction: row;
  justify-content: space-between;
}
.theme-four .calc-input ul li ul li {
  flex-flow: 1;
  width: 40px;
  height: 40px;
  text-align: center;
