    ...
    <div class="masks" v-show="currentValue"  >
        ...
        <div class="gesturePwd" >
            ...
            <div style="position: absolute;top:0;left:0;right:0;bottom:0;">
                ...
                <a v-if="loginflag==='true'" ref="updatePassword" style="position: absolute;left: 5px;top: 5px;color:#fff;font-size: 13px;display:block;" @click="updatePassword()">重置密码</a>
...
export default {
  ...
  created () {
    ...
    this.loginflag = sessionStorage.getItem('login-flag');
  },
  mounted() {
  ...
  methods: {
    ...
    closePwd () {
        ...
        if(this.loginflag==='true'){
            this.$router.push({path:'/Home/inf/money'});
        }else{
